...
window.onload = function () {
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			name: "High",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 30 },
				{ x: new Date(2017,1,3), y: 31 },
				{ x: new Date(2017,2,3), y: 33 },
				{ x: new Date(2017,3,3), y: 31 },
				{ x: new Date(2017,4,3), y: 32 },
				{ x: new Date(2017,5,3), y: 31 },
				{ x: new Date(2017,6,3), y: 30 },
				{ x: new Date(2017,7,3), y: 33 },
				{ x: new Date(2017,8,3), y: 32 },
				{ x: new Date(2017,9,3), y: 30 }
			]
...
<div id="main">
	...
	<div class="col-md-8">
		<h1>Bank Of America Corp.</h1>
		<h3>Finance Company</h3>
		<p align="justify">Bank of America Corporation (abbreviated as BofA) is a multinational banking and financial services corporation headquartered in Charlotte, North Carolina,
		United States. It is ranked 2nd on the list of largest banks in the United States by assets. As of 2016, Bank of America was the 26th largest company in the United States by 
		total revenue. In 2016, it was ranked #11 on the Forbes Magazine Global 2000 list of largest companies in the world.</p>
		<div class="box" id="bord">
				<h2>Bank Of America Corp.</h2>
