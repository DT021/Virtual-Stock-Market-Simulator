	...
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		{        
			...
			dataPoints: [
				...
				{ x: new Date(2017,1,3), y: 63 },
				{ x: new Date(2017,2,3), y: 62 },
				{ x: new Date(2017,3,3), y: 64 },
				{ x: new Date(2017,4,3), y: 65 },
				{ x: new Date(2017,5,3), y: 64 },
				{ x: new Date(2017,6,3), y: 66 },
				{ x: new Date(2017,7,3), y: 63 },
				{ x: new Date(2017,8,3), y: 66 },
				{ x: new Date(2017,9,3), y: 65 }
			]
		...
		{        
			...
			name: "Low",
			dataPoints: [
				{ x: new Date(2017,0,3), y: 62 },
				{ x: new Date(2017,1,3), y: 61 },
				{ x: new Date(2017,2,3), y: 60 },
				{ x: new Date(2017,3,3), y: 63 },
				{ x: new Date(2017,4,3), y: 62 },
				{ x: new Date(2017,5,3), y: 61 },
				{ x: new Date(2017,6,3), y: 59 },
				{ x: new Date(2017,7,3), y: 60 },
				{ x: new Date(2017,8,3), y: 61 },
				{ x: new Date(2017,9,3), y: 59 },
				{ x: new Date(2017,10,3), y: 60 },
				{ x: new Date(2017,11,3), y: 59}
			]
		}
		]         
	});
...
<div id="main">
	...
	<div class="col-md-8">
		<h1>American International Group Inc</h1>
		<h3>Finance Company</h3>
		<p align="justify">American International Group, Inc., also known as AIG, is an American multinational insurance corporation with operations in more than 80 countries and 
		jurisdictions. As of December 31, 2016, AIG companies employed 56,400 people. The company operates through three core businesses: General Insurance, Life & Retirement, and
		a standalone technology-enabled subsidiary. General Insurance includes Commercial, Personal Insurance, U.S. and International field operations. Life & Retirement includes 
		Group Retirement, Individual Retirement, Life, and Institutional Markets.</p>
